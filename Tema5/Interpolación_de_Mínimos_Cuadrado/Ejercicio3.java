...
public class Ejercicio3 {
    public static void main(String[] args) {
        // Datos de velocidad del automóvil: tiempo (x) y velocidad (y)
        double[] tiempo = {1, 2, 3, 4, 5};
        double[] velocidad = {20, 30, 40, 50, 60};

        // Grado del polinomio interpolador
        int grado = 2;

        // Realizar la interpolación de mínimos cuadrados
        double[] coeficientes = leastSquaresInterpolation(tiempo, velocidad, grado);
        ...
        System.out.println("La velocidad interpolada en " + tiempoObjetivo + " horas es: " + valorInterpolado);
    }
