...
public class Ejercicio5 {
    public static void main(String[] args) {
        ...
        System.out.println("\t\t\t\t -- Método de Newton (EJERCICIO 5) --"); 
    ...
    public static double func(double x) {
        return 3 * Math.pow(x, 5) - 4 * Math.pow(x, 2) - 19; // Definir la función cuya raíz se desea encontrar
    }

    public static double funcDerivada(double x) {
        return 15 * Math.pow(x, 4) - 8 * x;  //Definir la derivada de la función
    }
}
