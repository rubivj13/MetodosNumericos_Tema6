...
public class Ejercicio4 {
    public static void main(String[] args) {
        ...
        System.out.println("\t\t\t\t -- Método de Newton (EJERCICIO 4) --"); 
    ...
    public static double func(double x) {
        return Math.pow(x, 3) - 2 * Math.pow(x, 2) + 3 * x - 9; // Definir la función cuya raíz se desea encontrar
    }

    public static double funcDerivada(double x) {
        return 3 * Math.pow(x, 2) - 4 * x + 3;  //Definir la derivada de la función
    }
}
