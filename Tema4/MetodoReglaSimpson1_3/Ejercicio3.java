...
public class Ejercicio3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\t\t\t\t Método de la Regla de Simpson 1/3 - Ejercicio 3 \n");
        ...
        double b = 2 * Math.PI; // Límite superior

        // Número de subintervalos (debe ser par)
        int n = 4; // Ajustar este valor según la precisión deseada
        if (n % 2 != 0) {
