...
public class Ejercicio3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\t\t\t\t Método de la Regla de Simpson 3/8 - Ejercicio 3 \n");
        
        // Definir la función a integrar
        Function<Double, Double> f = x -> 1 / Math.sqrt(x * x * x + 1);

        // Límites de integración
        double a = 0.5; // Límite inferior
        double b = 2.5; // Límite superior

        // Número de subintervalos (debe ser múltiplo de 3)
        int n = 3; // Ajustar este valor según la precisión deseada
        if (n % 3 != 0) {
